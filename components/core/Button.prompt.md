Brass-filled primary action; use for "Request a Seat", "Request a Spot", "Request Consultation", and lane CTAs.

```jsx
<Button as="a" href="./events.html#event-register">Request a Seat</Button>
<Button lane="residents" as="a" href="./events.html#event-register">Request a Spot</Button>
